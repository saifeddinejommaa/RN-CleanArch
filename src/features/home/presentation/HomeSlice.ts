  ...
  extraReducers: (builder) => {
    builder
      .addCase(getCurrentMissionAction.pending, (state) => {
        state.currentMission = { data: null, status: RequestStatus.loading, error: undefined };
      })
      ...
      .addCase(getUpComingMissionAction.pending, (state) => {
        state.upComingMission = { data: null, status:  RequestStatus.loading, error: undefined };
      })
